...
set number autoread relativenumber nocompatible
...
nnoremap <Leader>do :call vimspector#Launch()<CR>
nnoremap <Leader>dx :call vimspector#Reset()<CR>
nnoremap <Leader>dg :call vimspector#Continue()<CR>

nnoremap <Leader>dt :call vimspector#ToggleBreakpoint()<CR>
nnoremap <Leader>dct :call vimspector#ToggleAdvancedBreakpoint()<CR>
